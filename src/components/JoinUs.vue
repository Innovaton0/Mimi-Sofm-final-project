  ...
  <section class="bg-[#F9EEDF] h-[100vh] font-mont text-black flex items-center justify-center"> 
    ...
    <!-- BOXS -->
      <div class="grid grid-cols-3 gap-10 max-w-[130rem] p-5">
        ...
        <div class="bg-white rounded-2xl flex flex-col items-start justify-between p-6 h-[320px] w-[240px] shadow-lg">
          <ul class="flex flex-col gap-4 pb-5">
            <h2 class="uppercase text-lg font-extrabold tracking-tight border-b-2 border-b-gray-800 pb-4">Suscripción PRO</h2>
            <li>· Publicaciones</li>
            <li>· Newsletter</li>
            <li>· Difusión en Web</li>
            <li>· Foro participativo</li>
          </ul>
          <div class="flex flex-col border-t-2 border-t-gray-800 w-[180px]">
        ...
        <!-- BOX3 -->
        <div class="flex flex-col items-center justify-self-start gap-6">
        <div class="bg-white rounded-2xl flex flex-col items-start justify-between p-6 h-[320px] w-[240px] shadow-lg">
          <ul class="flex flex-col gap-3 pb-5">
            <h2 class="uppercase text-lg font-extrabold tracking-tight leading-4 border-b-2 border-b-gray-800 pb-3">Suscripción Premium</h2>
            <li>· Publicaciones y Foro</li>
            <li>· Newsletter</li>
            <li>· Difusión en Redes Sociales y Web</li>
            <li>· Artista Destacado</li>
